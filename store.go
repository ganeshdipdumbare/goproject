...
// Sum returns the sum of all values currently in the store. It acquires the
// read lock for the duration of the iteration, so it is consistent with the
// concurrency handling in Get and Keys.

...
// Sum returns the total of all values currently in the store. It is guarded
// by the read lock, consistent with Get and Keys, so it is safe for concurrent
// use. An empty store returns 0.

...
// Sum returns the arithmetic sum of all values currently stored. An empty
// store returns 0. The read lock is held for the duration of the iteration,
// consistent with Get and Keys.
